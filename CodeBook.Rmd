...
measur <- names(SecDataSet)[3:81]
```

This file intends to be a guideline about the steps taken in order to succesfully arrive to a tidy data set. Also this file contains information about the variables in use.

The main two variables are:

**SubjId:** Varibale that identifies subject from 1 to 30.

**Activity:** Varibale that describes the activity that each one of each of the subjects studied performed.

Each activity is given by a number as follows: 1 - WALKING, 2 - WALKING_UPSTAIRS, 3 - WALKING_DOWNTAIRS, 4 - SITTING, 5 - STANDING, 6 - LAYING


**Measurements for X, Y and Z Reference Points**
